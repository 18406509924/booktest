# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-07-30 02:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='删除标记')),
                ('hbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booktests.BookInfo', verbose_name='所属图书')),
            ],
            options={
                'verbose_name': '英雄',
